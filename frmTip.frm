...
Begin VB.Form frmTip 
   ...
   Begin VB.CheckBox chkLoadTipsAtStartup 
      Caption         =   "&Show Tips when Network Chat starts."
      Height          =   315
      Left            =   120
      TabIndex        =   3
      Top             =   2880
...
Private Sub chkLoadTipsAtStartup_Click()
    ...
    SaveSetting App.Title, "Config", "Tips", chkLoadTipsAtStartup.Value
End Sub
...
Private Sub Form_Load()
    ...
    ShowAtStartup = GetSetting(App.Title, "Config", "Tips", 1)
    ...
    If LoadTips(App.Path & "\" & TIP_FILE) = False Then
        lblTipText.Caption = "The " & UCase$(TIP_FILE) & " file was not found?"
    End If
End Sub
